...
```markdown
    ...
    ![TemplatePrinter Example](https://raw.githubusercontent.com/avissian/pterm/master/_examples/template/animation.svg)

    <p align="center"><a href="https://github.com/avissian/pterm/blob/master/_examples/template/main.go" target="_blank">(Show source of demo)</a></p>
    ...
    |--------|-----------|
    |[FunctionName](https://pkg.go.dev/github.com/avissian/pterm#TemplatePrinter.FunctionName)|Description of function|
    ...
    |Option|Type|
    |------|----|
    |[OptionName](https://pkg.go.dev/github.com/avissian/pterm#TemplatePrinter.OptionName)|[TypeName](https://pkg.go.dev/github.com/avissian/pterm#TypeName)|
